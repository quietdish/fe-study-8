...
console.log( x + z ); //코딩자율학습 파트 3 page.16

console.log( 2 ** 4 );  //제곱**  //2^4   2*2*2*2 거듭제곱?
...
console.log( x == y );
console.log( x == z ); //숫자형 = 문자형

console.log( x === y );
console.log( x === z ); //숫자형 문자형 false
...
console.log( Number('12325') );
console.log( Number('12325.1254') );
