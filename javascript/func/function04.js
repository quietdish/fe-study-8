...
function arrForEach2(arr){      ///arr 매개변수,,
    for(let i in arr){
        console.log(i + " : " + arr[i]);        ///반복돌리면서 출력해주겠다,,,
    }
}
...
const printFunc = (index, value)=> {        //프린트펑션...
...
function arrForEach5(arr, func){    //매개변수 2개...
    for(let i in arr){  //i : index
        func(i, arr[i]);
    }
}
